...
/**
  Ray Tracer V4 : the rendering calculation is shared between 4 Promises
                + stronger separation between rendering calculation and final display in the canvas
*/
...
function main() {
    ...
    function promiseRender(xsize, ysize, x1, y1, x2, y2) {
        return new Promise((resolve) => {
            var response = rayTracer.render(xsize, ysize, x1, y1, x2, y2);
            resolve(response);
        });
    }
